...
NARRATIVE_MAP = {
    'bio_requerente': {
        'page': 5,
        'lines': [183,195,207,219,231,243,255,267,279,291,303,315,327,339,351,363,375,387,399,411,423,435],
        'x0': 70.7,
    },
    'bio_mae': {
        'page': 6,
        'lines': [181,193,205,217,229,241,253,265,277,289,301,313,325,337,349,361],
        'x0': 70.0,
    },
    'bio_pai': {
        'page': 6,
        'lines': [430,442,454,466,478,490,502,514,526,538,550,562,574,586,598],
        'x0': 70.0,
    },
    'bio_avo_mat': {
        'page': 7,
        'lines': [114,126,138,150,162,174,186,198,210,222,234],
        'x0': 70.0,
    },
    'bio_ava_mat': {
        'page': 7,
        'lines': [302,314,326,338,350,362,374,386,398,410,422,434,446,458,470],
        'x0': 70.0,
    },
    'bio_avo_pat': {
        'page': 7,
        'lines': [549,561,573,585,597,609,621,633,645,657,669,681,693,705,717],
        'x0': 70.0,
    },
    'bio_ava_pat': {
        'page': 8,
        'lines': [170,182,194,206,218,230,242,254,266,278,290,302,314,326,338],
        'x0': 70.7,
    },
    'bio_bisavos': {
        'page': 8,
        'lines': [439,451,463,475,487,499,511,523,535,547,559,571,583,595,607,619,631],
        'x0': 70.7,
    },
    'info_decisoes_irmaos': {
        'page': 9,
        'lines': [141,153,165,177,189],
        'x0': 69.3,
    },
    'info_docs_poloneses': {
        'page': 9,
        'lines': [250,262,274,286,298],
        'x0': 69.3,
    },
    'info_renuncia': {
        'page': 9,
        'lines': [381,393,405,417,429],
        'x0': 69.3,
    },
    'info_adicional': {
        'page': 9,
        'lines': [487,499,511,523,535,547,559,571,583,595,607,619,631,643,655,667,679,691,703,715],
        'x0': 69.3,
    },
    'anexos_lista': {
        'page': 10,
        'lines': [116,128,140,152,164,176,188,200,212,224],
        'x0': 70.0,
    },
}
